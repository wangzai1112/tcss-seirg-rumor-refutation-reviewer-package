...
The current environment does not contain a Zenodo access token, so a DOI was not minted automatically. The GitHub reviewer-access repository is active:

`https://github.com/wangzai1112/tcss-seirg-rumor-refutation-reviewer-package`
...
3. Use the GitHub release `v0.7.5-tcss-reviewer-20260615` as the DOI source.
...
- Creator: Guohao Sun
- Version: v0.7.5-tcss-reviewer-20260615
...
- Related identifier: GitHub release URL for `v0.7.5-tcss-reviewer-20260615`
